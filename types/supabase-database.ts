  ...
  menuca_v3: {
    Tables: {
      ...
      restaurant_locations: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["restaurant_locations"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["restaurant_locations"]["Insert"]
        >;
      };
      ...
      restaurant_contacts: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["restaurant_contacts"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["restaurant_contacts"]["Insert"]
        >;
      };
      ...
      restaurant_domains: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["restaurant_domains"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["restaurant_domains"]["Insert"]
        >;
      };
      ...
      restaurant_schedules: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["restaurant_schedules"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["restaurant_schedules"]["Insert"]
        >;
      };
      ...
      delivery_and_pickup_configs: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["delivery_and_pickup_configs"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["delivery_and_pickup_configs"]["Insert"]
        >;
      };
      ...
      cities: {
        ...
        Insert: Omit<Database["menuca_v3"]["Tables"]["cities"]["Row"], "id"> & {
          id?: number;
        };
      ...
      users: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["users"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
      ...
      admin_users: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["admin_users"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["admin_users"]["Insert"]
        >;
      };
      ...
      admin_user_restaurants: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["admin_user_restaurants"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["admin_user_restaurants"]["Insert"]
        >;
      };
      ...
      user_addresses: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["user_addresses"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["user_addresses"]["Insert"]
        >;
      };
      ...
      user_delivery_addresses: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["user_delivery_addresses"]["Row"],
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["user_delivery_addresses"]["Insert"]
        >;
      };
      ...
      user_favorite_restaurants: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["user_favorite_restaurants"]["Row"],
          "id" | "created_at"
        > & {
          id?: number;
          created_at?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["user_favorite_restaurants"]["Insert"]
        >;
      };
      ...
      user_payment_methods: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["user_payment_methods"]["Row"],
          "id" | "uuid" | "created_at" | "updated_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["user_payment_methods"]["Insert"]
        >;
      };
      ...
      courses: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["courses"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
      ...
      dishes: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["dishes"]["Row"],
          "id" | "uuid" | "search_vector" | "created_at"
        > & {
          id?: number;
          uuid?: string;
          created_at?: string;
      ...
      dish_prices: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["dish_prices"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["dish_prices"]["Insert"]
        >;
      };
      ...
      ingredients: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["ingredients"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["ingredients"]["Insert"]
        >;
      };
      ...
      ingredient_groups: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["ingredient_groups"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["ingredient_groups"]["Insert"]
        >;
      };
      ...
      ingredient_group_items: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["ingredient_group_items"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["ingredient_group_items"]["Insert"]
        >;
      };
      ...
      combo_groups: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["combo_groups"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["combo_groups"]["Insert"]
        >;
      };
      ...
      combo_items: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["combo_items"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["combo_items"]["Insert"]
        >;
      };
      ...
      combo_group_sections: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["combo_group_sections"]["Row"],
          "id" | "uuid" | "created_at" | "updated_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["combo_group_sections"]["Insert"]
        >;
      };
      ...
      combo_modifier_groups: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["combo_modifier_groups"]["Row"],
          "id" | "uuid" | "created_at" | "updated_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["combo_modifier_groups"]["Insert"]
        >;
      };
      ...
      combo_modifiers: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["combo_modifiers"]["Row"],
          "id" | "uuid" | "created_at" | "updated_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["combo_modifiers"]["Insert"]
        >;
      };
      ...
      combo_modifier_prices: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["combo_modifier_prices"]["Row"],
          "id" | "uuid" | "created_at" | "updated_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["combo_modifier_prices"]["Insert"]
        >;
      };
      ...
      combo_modifier_placements: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["combo_modifier_placements"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["combo_modifier_placements"]["Insert"]
        >;
      };
      ...
      dish_combo_groups: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["dish_combo_groups"]["Row"],
          "id" | "uuid" | "created_at" | "updated_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["dish_combo_groups"]["Insert"]
        >;
      };
      ...
      order_item_modifiers: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["order_item_modifiers"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["order_item_modifiers"]["Insert"]
        >;
      };
      ...
      dish_modifiers: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["dish_modifiers"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["dish_modifiers"]["Insert"]
        >;
      };
      ...
      dish_modifier_prices: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["dish_modifier_prices"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["dish_modifier_prices"]["Insert"]
        >;
      };
      ...
      orders: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["orders"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
      ...
      order_items: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["order_items"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["order_items"]["Insert"]
        >;
      };
      ...
      promotional_deals: {
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["promotional_deals"]["Insert"]
        >;
      };
      ...
      promotional_coupons: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["promotional_coupons"]["Row"],
          "id" | "uuid" | "created_at"
        > & {
          id?: number;
          uuid?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["promotional_coupons"]["Insert"]
        >;
      };
      ...
      coupon_usage_log: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["coupon_usage_log"]["Row"],
          "id" | "used_at"
        > & {
          id?: number;
          used_at?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["coupon_usage_log"]["Insert"]
        >;
      };
      ...
      audit_log: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["audit_log"]["Row"],
          "id" | "created_at"
        > & {
          id?: number;
          created_at?: string;
      ...
      rate_limits: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["rate_limits"]["Row"],
          "id"
        > & { id?: number };
        Update: Partial<
          Database["menuca_v3"]["Tables"]["rate_limits"]["Insert"]
        >;
      };
      ...
      email_queue: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["email_queue"]["Row"],
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["email_queue"]["Insert"]
        >;
      };
      ...
      failed_jobs: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["failed_jobs"]["Row"],
          "id" | "failed_at"
        > & {
          id?: number;
          failed_at?: string;
        ...
        Update: Partial<
          Database["menuca_v3"]["Tables"]["failed_jobs"]["Insert"]
        >;
      };
      ...
      devices: {
        ...
        Insert: Omit<
          Database["menuca_v3"]["Tables"]["devices"]["Row"],
          "id" | "uuid" | "created_at" | "updated_at"
        > & {
          id?: number;
          uuid?: string;
...
export type ComboGroupSection =
  Database["menuca_v3"]["Tables"]["combo_group_sections"]["Row"];
export type ComboModifierGroup =
  Database["menuca_v3"]["Tables"]["combo_modifier_groups"]["Row"];
export type ComboModifier =
  Database["menuca_v3"]["Tables"]["combo_modifiers"]["Row"];
export type ComboModifierPrice =
  Database["menuca_v3"]["Tables"]["combo_modifier_prices"]["Row"];
export type ComboModifierPlacement =
  Database["menuca_v3"]["Tables"]["combo_modifier_placements"]["Row"];
export type DishComboGroup =
  Database["menuca_v3"]["Tables"]["dish_combo_groups"]["Row"];

 ...
 * 
 * Queries the Supabase database (menuca_v3 schema) to get the delivery 
 * provider configuration for a restaurant.
 * 
 * Tables used:
 * - delivery_providers: Provider definitions (restozone, etc.)
 * - delivery_and_pickup_configs: Restaurant-specific config with FK to provider
 */

...
const LOGO_URL =
  "https://nthpbtdjhhnwfxqsxbvy.supabase.co/storage/v1/object/public/email-assets/logo.png";
const HERO_BG_URL =
  "https://nthpbtdjhhnwfxqsxbvy.supabase.co/storage/v1/object/public/email-assets/hero-bg.jpg";
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={heroSection}>
            ...
            <Text style={heroText}>
              Thank you for creating an account. You're all set to enjoy a
          ...
          <Section style={section}>
            ...
            <Text style={paragraph}>
              We're excited to have you join Menu.ca! Your account is now active
              and ready to make ordering from your favorite local restaurants
              easier than ever.
            </Text>
            ...
            <div style={benefitsList}>
              <div style={benefitItem}>
                ...
                <div>
                  ...
                  <Text style={benefitDescription}>
                    Save your delivery addresses and payment methods for quick,
                    seamless ordering
                  </Text>
                </div>
              </div>
              ...
              <div style={benefitItem}>
                ...
                <div>
                  ...
                  <Text style={benefitDescription}>
                    Easily view past orders and reorder your favorites with one
                    click
                  </Text>
                </div>
              </div>
              ...
              <div style={benefitItem}>
                ...
                <div>
                  ...
                  <Text style={benefitDescription}>
                    Stay updated on your order status from preparation to
                    delivery
                  </Text>
                </div>
              </div>
            ...
            <Section style={buttonContainer}>
              <Button style={button} href="https://menuai.ca">
                Start Ordering
              </Button>
            </Section>

            <Text style={paragraph}>
              Ready to explore? Browse restaurants in your area and discover
              delicious meals from local favorites.
            </Text>
          </Section>
          ...
          <Section style={section}>
            <Text style={helpText}>
              Need help getting started? Have questions about your account? Our
              support team is here to assist you.
            </Text>
          </Section>

          <Section style={footer}>
            <Text style={footerText}>Thank you for choosing Menu.ca!</Text>
            <Text style={footerSubtext}>
              Powered by Menu.ca - Connecting you with local restaurants
            </Text>
            <Text style={footerEmail}>Your email: {email}</Text>
          </Section>
        </Container>
      </Body>
    </Html>

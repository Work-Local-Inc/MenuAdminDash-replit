...
export async function PUT(
  ...
  try {
    ...
    const { column: areaCol, value: areaVal } = resolveIdParam(params.areaId);
    ...
    if (validatedData.delivery_fee !== undefined)
      updateData.delivery_fee = validatedData.delivery_fee;
    if (validatedData.min_order !== undefined)
      updateData.delivery_min_order = validatedData.min_order;
    if (validatedData.polygon !== undefined)
      updateData.geometry = validatedData.polygon;
    if (validatedData.is_active !== undefined)
      updateData.is_active = validatedData.is_active;

    console.log(
      "[DELIVERY AREAS API] PUT - Updating area",
      params.areaId,
      "for restaurant",
      params.id,
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.log(
      "[DELIVERY AREAS API] DELETE - Removing area",
      params.areaId,
      "for restaurant",
      params.id,
    );
